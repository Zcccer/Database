Before running this program on your computer, please confirm that the JDBC driver has been placed in the same folder, and the sql file has been imported into your mysql. And please put all codes: 
